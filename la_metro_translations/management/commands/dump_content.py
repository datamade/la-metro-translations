...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        app_models = apps.get_app_config("la_metro_translations").get_models()

        excluded_app_models = [
            f"la_metro_translations.{m.__name__}"
            for m in app_models
        ...
        call_command(
            ...
            indent=4,
            output=Path("la_metro_translations/fixtures/cms_content.json"),
            exclude=[
                "contenttypes",
                "auth.permission",
        ...
        subprocess.run(
            [
                ...
                "-R",
                "media/.",
                "la_metro_translations/fixtures/initial_images/",
            ],
            check=True,
        )
